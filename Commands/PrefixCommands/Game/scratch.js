...
const commands = new commandBuilders({
  ...
  category: path.parse(__dirname).name, // thể loại lệnh, Utility, Infomation ...
  ...
  let positions = [
    {
      r: { custom_id: "r1", emoji: { name: `${options.ic}` }, style: ButtonStyle.Success, type: ComponentType.Button, disabled: true },
      a: { label: `-`, style: ButtonStyle.Secondary, type: ComponentType.Button, custom_id: 'a1' }
    },
    {
      r: { custom_id: "r2", label: "-", style: ButtonStyle.Danger, disabled: true, type: ComponentType.Button, },
      a: { custom_id: "a2", label: "-", style: ButtonStyle.Secondary, type: ComponentType.Button, }
    },
    {
      r: { emoji: { name: `${options.ic}` }, style: ButtonStyle.Success, type: ComponentType.Button, custom_id: "r3", disabled: true },
      a: { custom_id: "a3", label: "-", style: ButtonStyle.Secondary, type: ComponentType.Button, },
    },
    {
      r: { emoji: { name: `${options.ic}` }, style: ButtonStyle.Success, type: ComponentType.Button, custom_id: "r4", disabled: true },
      a: { custom_id: "a4", label: "-", style: ButtonStyle.Secondary, type: ComponentType.Button, },
    },
    {
      r: { emoji: { name: `${options.jc}` }, style: ButtonStyle.Primary, type: ComponentType.Button, custom_id: "r5", disabled: true },
      a: {
        custom_id: "a5",
        label: "-",
