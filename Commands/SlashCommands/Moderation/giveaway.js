...
const { commandBuilders, classComponent } = require(`${process.cwd()}/Events/functions`);
const funct = new classComponent();
module.exports = {
  ...
  run: async(client, interaction) => {
    ...
    if(subCommands === "start") {
      ...
      return await client.giveawaysManager.startGiveaway(interaction, channel);
      ...
      const messageId = interaction.options.getString("message_id");
      const addDurationMs = funct.ms(interaction.options.getString("add_duration"));
